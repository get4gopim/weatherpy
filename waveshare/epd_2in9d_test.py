...
import logging
from epddriver2in9 import epd2in9d
import time
...
try:
    ...
    draw.text((2, 0), 'hello world', font = font15, fill = 0)
    draw.text((2, 20), '2.9inch epd d', font = font15, fill = 0)
    draw.text((20, 50), u'微雪电子', font = font15, fill = 0)
    ...
    bmp = Image.open(os.path.join(picdir, 'cloudy.bmp'))
